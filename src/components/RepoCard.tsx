...
const RepoCard = ({ repo }: { repo: IRepo }) => {
    ...
    return (
        <div className="border py-3 px-5 rounded mb-2 hover:shadow-md hover:bg-gray-100 transition-all flex justify-between flex-wrap">
            <a href={repo.html_url} target='_blank' className="hover:cursor-pointer hover:underline max-w-[400px]">
